...
public class BookmarkModelListMB extends AbstractListPageBean<Bookmark, Long> {
	...
	public List<BookmarkModel> getHandleResultListModels() {
		return this.bc.findAllModels();
	}
